...
Hi, I'm currently pursuing my PhD degree in [DSA Thrust](http://dsa.hkust-gz.edu.cn/) at **The Hong Kong University of Science and Technology (Guangzhou)**, under the guidance of [Prof. Yuxuan Liang](https://yuxuanliang.com/) & [Prof. Yangqiu Song](https://www.cse.ust.hk/~yqsong/). Previously, I obtained my BEng degree from **Hefei University of Technology**, [School of Artificial Intelligence](https://ci.hfut.edu.cn/).  My research interests are centered around **Multimodal Learning** and **Spatio-Temporal Data Mining**, with a particular emphasis on visual-language pre-training, generative models, and innovative applications in Urban Computing.
